    ...
    $("button").click(function(){
        ...
        $('#container ul').append(`<li><span id="ff">&#10005</span><span class="reorder-up">&#8593;</span><span class="reorder-down">&#8595;</span> ${newTodoText}</li>`);
        $('#iminput').val("");
       
    });


      $('#container ul').on('click', '#ff', function (event) {
